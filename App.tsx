...
// Sub-components defined outside the main App component for clarity and performance
const Hero = () => (
      ...
      <div className="grid lg:grid-cols-12 gap-10 mb-16 items-end">
        ...
        <div className="lg:col-span-4 lg:text-right">
          <div className="p-4 lg:p-6 bg-[#fdfcf8] border-r-4 border-amber-600 shadow-xl relative overflow-hidden group">
            ...
            <p className="text-slate-800 font-bold italic text-xl lg:text-xl leading-relaxed relative z-10">
              针对不同维度的痛点，由行业专家和名校导师提供深度规划辅导
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#fdfcf8] editorial-border relative group mb-24">
        ...
        <div className="relative z-10 p-10 lg:p-16">
          <div className="flex flex-wrap items-center gap-10 mb-12">
            ...
            <div>
              <h3 className="serif text-3xl font-bold text-slate-900 mb-2">模块 1：就业认知与实习规划</h3>
            ...
            <div className="lg:ml-24 flex items-start gap-4 bg-white border border-amber-500/10 px-8 py-5 shadow-lg relative z-20">
              ...
              <div className="text-left flex flex-col gap-1">
                ...
                <div className="flex items-center gap-2">
                  <span className="block text-lg font-bold text-slate-900 leading-tight">该相关行业的资深从业者（5-10年经验）</span>
                  <span className="text-slate-200 font-light">|</span>
                  <span className="text-base font-medium text-slate-500 whitespace-nowrap">1对1深度沟通</span>
                </div>
              </div>
            </div>
          </div>
          <div className="grid lg:grid-cols-12 gap-12 items-stretch">
            ...
            <div className="lg:col-span-8 flex flex-col gap-10">
              <div>
                ...
                <div className="editorial-border overflow-hidden bg-white shadow-sm">
                  ...
                  {[
                    ...
                    { q: '哪些岗位适合我？', a: '岗位类型、工作内容、入职要求（专业/技能等）' },
              ...
              <div className="bg-amber-50/30 py-6 px-8 lg:py-7 lg:px-10 editorial-border relative flex-1">
                ...
                <p className="text-slate-500 text-sm italic mb-4">根据申请人需求和行业特点，灵活选择深度内容，包括但不限于：</p>
            ...
            <div className="lg:col-span-4 flex flex-col justify-start gap-6">
              <div className="bg-slate-900 text-white p-6 lg:p-7 shadow-2xl relative overflow-hidden">
                ...
                <div className="space-y-5 relative z-10">
                   {[
                     { label: '实习规划', desc: '不同年级应该做什么类型的实习；实习时长和段数建议；递进式实习路径建议' },
              ...
              <div className="p-6 lg:p-8 border-2 border-slate-900 bg-white relative shadow-sm">
                 ...
                 <div className="flex gap-4 items-start mt-4 group">
                    ...
                    <div>
                       ...
                       <a href="https://www.seeyooedu.com/qfy-content/uploads/2026/03/08b3fa96e422b2ff86989981376cb31a.pdf" target="_blank" rel="noopener noreferrer" className="ml-3 font-medium text-red-600 transition-colors hover:text-amber-700 underline underline-offset-4 decoration-2">点击查看样本 </a>
      ...
      <div className="bg-[#fdfcf8] editorial-border relative group mb-24">
        ...
        <div className="relative z-10 p-10 lg:p-16">
          <div className="flex flex-wrap items-center gap-10 mb-12">
            ...
            <div>
              <h3 className="serif text-3xl font-bold text-slate-900 mb-2">模块 2：学术认知与专业路径规划</h3>
            ...
            <div className="lg:ml-24 flex items-start gap-4 bg-white border border-amber-500/10 px-8 py-5 shadow-lg relative z-20">
              ...
              <div className="text-left flex flex-col gap-1">
                <span className="block text-[11px] font-black uppercase text-amber-600 tracking-widest">服务提供者：</span>
                <div className="flex items-center gap-2">
                  <span className="block text-lg font-bold text-slate-900 leading-tight">同专业方向的海外名校导师</span>
                  <span className="text-slate-200 font-light">|</span>
                  <span className="text-base font-medium text-slate-500 whitespace-nowrap">1对1深度沟通</span>
                </div>
              </div>
              ...
              <div className="bg-white border border-slate-100 p-8 shadow-sm mb-12">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                  {[
                    ...
                    { q: '如何规划时间和背景？', a: '从现在到申请时，每个年级应该分阶段做什么事情？' }
                  ].map((item, idx) => (
                    <div key={idx} className="flex flex-col h-full group/problem">
            ...
            <div className="lg:col-span-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                {[
                  ...
                  { dim: '维度3：竞赛规划', content: '要不要做竞赛？做什么竞赛？', harvest: '分析不同类型竞赛的含金量与认可度，提供竞赛选择和时间规划建议' },
      ...
      <div className="bg-[#fdfcf8] editorial-border relative group mb-24">
        ...
        <div className="relative z-10 p-10 lg:p-16">
          <div className="flex flex-wrap items-center gap-10 mb-12">
            ...
            <div>
              <h3 className="serif text-3xl font-bold text-slate-900 mb-2">模块 3：科研规划</h3>
            ...
            <div className="lg:ml-24 flex items-start gap-4 bg-white border border-amber-500/10 px-8 py-5 shadow-lg relative z-20">
              ...
              <div className="text-left flex flex-col gap-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-200 font-light">|</span>
                  <span className="text-base font-medium text-slate-500 whitespace-nowrap">1对1沟通</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-[#fdfcf8] editorial-border relative group mb-0">
        ...
        <div className="relative z-10 p-10 lg:p-16">
          <div className="flex flex-wrap items-center gap-10 mb-12">
            ...
            <div>
              <h3 className="serif text-3xl font-bold text-slate-900 mb-2">模块 4：定制标化备考方案</h3>
              ...
              <div className="bg-white border border-slate-100 p-8 shadow-sm mb-12">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                  {[
                    ...
                    { q: '考试时间？目标分数？', a: '什么时候首考？刷分？目标分数是多少？' },
               ...
               <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                 {[
                   ...
                   { 
                     ...
                     content: '如需报班，可匹配合适的语培机构；提供机构推荐和建议' 
                   }
                 ].map((s, idx) => (
                ...
                <div className="bg-[#1a1c1e] text-white px-10 py-10 shadow-2xl relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-12 border-t-8 border-[#9b1c1c]">
                    ...
                    <div className="relative z-10 flex items-center gap-8 max-w-md">
                       ...
                       <div>
                          ...
                          <a href="https://www.seeyooedu.com/qfy-content/uploads/2026/03/87350d806d6195944bf9914db8604627.pdf" target="_blank" rel="noopener noreferrer" className="ml-3 font-medium text-yellow-600 transition-colors hover:text-amber-700 underline underline-offset-4 decoration-2">点击查看样本 </a>
            ...
            {[
              ...
              <button 
                ...
                className={`transition-colors relative group whitespace-nowrap ${
                  (item.id === 'team' && currentView === 'team') || (item.id !== 'team' && currentView === 'home')
                  ? 'text-amber-600 font-bold' 
                  : 'hover:text-amber-600'
                }`}
              >
                {item.label}
                <span className={`absolute -bottom-1 left-0 h-px bg-amber-600 transition-all ${
                  (item.id === 'team' && currentView === 'team') ? 'w-full' : 'w-0 group-hover:w-full'
                }`}></span>
              </button>
            ))}
          </div>
        ...
        <div className="max-w-screen-2xl mx-auto px-8 lg:px-16 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex md:justify-end gap-16 text-[16px] font-black uppercase tracking-[0.3em] text-slate-500">
            <div className="space-y-3 flex flex-col">
              ...
              <button onClick={() => handleNavClick('modules')} className="hover:text-amber-600 text-left">多元申请规划的四大模块</button>
              <button onClick={() => handleNavClick('process')} className="hover:text-amber-600 text-left">多元申请规划的服务流程</button>
            </div>
          </div>
        </div>
      </footer>
